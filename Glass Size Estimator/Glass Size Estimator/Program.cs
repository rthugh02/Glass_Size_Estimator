...
namespace Glass_Size_Estimator
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Debug.WriteLine("Resulting Width " + (float)(productList[0].Logic["ResultingWidth"].Process(28.75f, parameters)));
            Debug.WriteLine("Resulting Height " + (float)(productList[0].Logic["ResultingHeight"].Process(66.625f, parameters)));
            Debug.WriteLine("Wall Jamb " + (productList[0].Logic["WallJamb"].Process(28.75f, parameters)).ToString());
