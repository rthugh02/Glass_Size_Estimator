...
namespace Glass_Size_Estimator
{
	public class StateMachine
	{
		...
		public Object Process(Object input, Dictionary<string, object> parameters)
		{
			...
			// Reset the next state jumps to their default values (for next processing)
			for (int i = 0; i < States.Count; i++)
			{
				States[i].NextState = i + 1;
			}
